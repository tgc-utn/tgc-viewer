...
namespace TGC.Examples.MeshCreator.Primitives
{
    ...
    public class PlaneYZPrimitive : EditorPrimitive
    {
        ...
        public override void initCreation(Vector3 gridPoint)
        {
            ...
            mesh = new TgcPlaneWall(initSelectionPoint, new Vector3(0, 0, 0), TgcPlaneWall.Orientations.YZplane,
                planeTexture);
        ...
        public override void doCreation()
        {
            ...
            if (input.buttonDown(TgcD3dInput.MouseButtons.BUTTON_LEFT))
            {
                ...
                var extensionPoint = new Vector3(initSelectionPoint.X, initSelectionPoint.Y + adjustedHeightY,
                    collisionPoint.Z);
        ...
        {
            var p = new PlaneYZPrimitive(Control);
            p.mesh = mesh.clone();
