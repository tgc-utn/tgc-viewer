...
namespace TGC.Core.Geometries
{
    ...
    public class TgcTriangle : IRenderObject
    {
        ...
        public TgcMesh toMesh(string meshName)
        {
            ...
            var d3dMesh = new Mesh(1, 3, MeshFlags.Managed, Core.SceneLoader.TgcSceneLoader.VertexColorVertexElements,
            ...
            using (var vb = d3dMesh.VertexBuffer)
            {
                ...
                Core.SceneLoader.TgcSceneLoader.VertexColorVertex v;

                //a
                v = new Core.SceneLoader.TgcSceneLoader.VertexColorVertex();
                v.Position = A;
                v.Normal = normal;
                v.Color = ci;
                data.Write(v);
