...
namespace TGC.Core.SkeletalAnimation
{
    ...
    public class TgcSkeletalMesh : IRenderObject, ITransformObject
    {
        ...
        protected Dictionary<string, Core.SkeletalAnimation.TgcSkeletalAnimation> animations;
        ...
        protected Core.SkeletalAnimation.TgcSkeletalAnimation currentAnimation;
        ...
        /// </summary>
        public Dictionary<string, Core.SkeletalAnimation.TgcSkeletalAnimation> Animations
        {
        ...
        /// </summary>
        public Core.SkeletalAnimation.TgcSkeletalAnimation CurrentAnimation
        {
        ...
        protected void initData(Mesh mesh, string name, MeshRenderType renderType, TgcSkeletalBone[] bones)
        {
            ...
            currentFrame = 0;
            animations = new Dictionary<string, Core.SkeletalAnimation.TgcSkeletalAnimation>();
