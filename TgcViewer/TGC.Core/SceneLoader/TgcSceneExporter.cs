...
namespace TGC.Core.SceneLoader
{
    ...
    public class TgcSceneExporter
    {
        ...
        private void exportMeshVertexColor(TgcMesh tgcMesh, MeshExport meshExport, TgcMeshData meshData)
        {
            ...
            var vbData = (Core.SceneLoader.TgcSceneLoader.VertexColorVertex[])tgcMesh.D3dMesh.LockVertexBuffer(
                typeof(Core.SceneLoader.TgcSceneLoader.VertexColorVertex),
                LockFlags.ReadOnly,
        ...
        private void exportMeshDiffuseMap(TgcMesh tgcMesh, MeshExport meshExport, TgcMeshData meshData)
        {
            ...
            //Obtener datos del VertexBuffer
            var vbData = (Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex[])tgcMesh.D3dMesh.LockVertexBuffer(
                typeof(Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex),
                LockFlags.ReadOnly,
                tgcMesh.D3dMesh.NumberVertices);
            tgcMesh.D3dMesh.UnlockVertexBuffer();
        ...
        {
            //Obtener datos del VertexBuffer
            var vbData = (Core.SceneLoader.TgcSceneLoader.DiffuseMapAndLightmapVertex[])tgcMesh.D3dMesh.LockVertexBuffer(
                typeof(Core.SceneLoader.TgcSceneLoader.DiffuseMapAndLightmapVertex),
                LockFlags.ReadOnly,
                tgcMesh.D3dMesh.NumberVertices);
            tgcMesh.D3dMesh.UnlockVertexBuffer();
        ...
        public TgcMesh mergeTwoMeshes(TgcMesh mesh1, TgcMesh mesh2)
        {
            ...
            var vertexElements = mesh1.RenderType == TgcMesh.MeshRenderType.VERTEX_COLOR
                ? Core.SceneLoader.TgcSceneLoader.VertexColorVertexElements
                : Core.SceneLoader.TgcSceneLoader.DiffuseMapVertexElements;
            ...
            {
                //Cargar VertexBuffer
                var vertsData = new Core.SceneLoader.TgcSceneLoader.VertexColorVertex[vertexCount];
                //Agregar los datos del mesh1
                var verts1 = (Core.SceneLoader.TgcSceneLoader.VertexColorVertex[])mesh1.D3dMesh.LockVertexBuffer(
                    typeof(Core.SceneLoader.TgcSceneLoader.VertexColorVertex), LockFlags.ReadOnly, mesh1.D3dMesh.NumberVertices);
                ...
                //Agregar los datos del mesh1
                var verts2 = (Core.SceneLoader.TgcSceneLoader.VertexColorVertex[])mesh2.D3dMesh.LockVertexBuffer(
                    typeof(Core.SceneLoader.TgcSceneLoader.VertexColorVertex), LockFlags.ReadOnly, mesh2.D3dMesh.NumberVertices);
            ...
            {
                //Cargar VertexBuffer
                var vertsData = new Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex[vertexCount];

                //Agregar los datos del mesh1 (aplicarle la transformacion actual)
                var verts1 = (Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex[])mesh1.D3dMesh.LockVertexBuffer(
                    typeof(Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex), LockFlags.ReadOnly, mesh1.D3dMesh.NumberVertices);
                for (var i = 0; i < verts1.Length; i++)
                {
                    verts1[i].Position = TgcVectorUtils.transform(verts1[i].Position, mesh1.Transform);
                }
                ...
                //Agregar los datos del mesh1
                var verts2 = (Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex[])mesh2.D3dMesh.LockVertexBuffer(
                    typeof(Core.SceneLoader.TgcSceneLoader.DiffuseMapVertex), LockFlags.ReadOnly, mesh2.D3dMesh.NumberVertices);
                for (var i = 0; i < verts2.Length; i++)
                {
                    verts2[i].Position = TgcVectorUtils.transform(verts2[i].Position, mesh2.Transform);
                }
