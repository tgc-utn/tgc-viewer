...
namespace TGC.Core.BoundingVolumes
{
    ...
    public class TgcBoundingAxisAlignBox : IRenderObject
    {
        ...
        public void Render()
        {
            ...
            //Actualizar vertices de BoundingBox solo si hubo una modificaci�n
            if (dirtyValues)
            {
                updateValues();
                dirtyValues = false;
        ...
        /// <summary>
        ///     Tama�o de cada dimensi�n del BoundingBox
        /// </summary>
        ...
        /// Si el BoundingBox tenia alguna rotaci�n, se pierde.
        /// </summary>
        /// <param name="position">Nueva posici�n absoluta de referencia</param>
        ...
        /// <summary>
        ///     Transforma el BondingBox en base a una matriz de transformaci�n.
        ...
        ///     m�s la transformaci�n pedida.
        ///     Si el BoundingBox se transform� y luego se llama a scaleTranslate(), se respeta
        ///     la traslaci�n y la escala, pero la rotaci�n se va a perder.
        /// </summary>
        ...
        /// <summary>
        ///     Calcula los pol�gonos que conforman las 6 caras del BoundingBox
        /// </summary>
        /// <returns>Array con las 6 caras del pol�gono en el siguiente orden: Up, Down, Front, Back, Right, Left</returns>
        ...
        /// <summary>
        ///     Cara de un BoundingBox representada por un pol�gono rectangular de 4 v�rtices.
        /// </summary>
        public class Face
        {
            public Face()
            ...
            /// <summary>
            ///     Los 4 v�rtices extremos de la cara
            /// </summary>
            public TGCVector3[] Extremes { get; set; }

            /// <summary>
            ///     Ecuaci�n del plano que engloba la cara, con su normal apuntado hacia afuera normalizada.
            /// </summary>
