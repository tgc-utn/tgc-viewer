...
namespace TGC.Core.SkeletalAnimation
{
    ...
    public class TgcSkeletalMesh : IRenderObject, ITransformObject
    {
        ...
        ///     Coincide con el tama�o del array de matrices que se envia
        ...
        /// <summary>
        ///     BoundingBox de la malla sin ninguna animaci�n.
        /// </summary>
        ...
        ///     Reutiliza toda la geometr�a de la malla original sin duplicarla.
        ...
        /// <param name="translation">Traslaci�n respecto de la malla original</param>
        /// <param name="rotation">Rotaci�n respecto de la malla original</param>
            ...
            TGCVector3 scale)
        {
            ...
            //Almacenar transformaci�n inicial
        ...
        ///     Puede variar seg�n la animaci�n que tiene configurada en el momento.
        /// </summary>
        ...
        /// <summary>
        ///     Huesos del esqueleto de la malla. Ordenados en forma jer�rquica
        /// </summary>
        ...
        /// <summary>
        ///     Indica si actualmente hay una animaci�n en curso.
        /// </summary>
        ...
        /// <summary>
        ///     Indica si la animaci�n actual se ejecuta con un Loop
        /// </summary>
        ...
        /// <summary>
        ///     Modelos adjuntados para seguir la trayectoria de alg�n hueso
        /// </summary>
        ...
        /// <summary>
        ///     Cantidad de tri�ngulos de la malla
        /// </summary>
        ...
        /// <summary>
        ///     Cantidad de v�rtices de la malla
        /// </summary>
        ...
        /// <summary>
        ///     Crea mallas a modo Debug para visualizar la configuraci�n del esqueleto
        /// </summary>
        ...
        /// <param name="userFrameRate">FrameRate personalizado. Con -1 se utiliza el default de la animaci�n</param>
        ...
        ///     Si la animacion activa es la misma que ya esta siendo animada actualmente, no se para ni se reinicia.
        ///     Para forzar que se reinicie es necesario hacer stopAnimation().
        ///     Utiliza el FrameRate default de cada animaci�n
        /// </summary>
        /// <param name="animationName">Nombre de la animacion a activar</param>
        /// <param name="playLoop">Indica si la animacion vuelve a comenzar al terminar</param>
        ...
        {
            //Precalcular la multiplicaci�n para llevar a un vertice a Bone-Space y luego transformarlo segun el hueso
        ...
        /// <summary>
        ///     Devuelve un array con todas las posiciones de los v�rtices de la malla, en el estado actual
        /// </summary>
        ...
        /// <summary>
        ///     Cambia el color de todos los v�rtices de la malla, actualizando el VertexBuffer
        ///     En modelos complejos puede resultar una operaci�n poco performante.
        ///     La actualizaci�n ser� visible la pr�xima vez que se haga updateAnimation().
        ///     Si hay instnacias de este modelo, sea el original o una copia, todos los dem�s se ver�n
        ///     afectados
        /// </summary>
        ...
        ///     Se debe crear despu�s de haber agregado todas las animaciones al original.
        ...
        /// <summary>
        ///     Indica que la animaci�n actual ha finalizado.
        ///     Se llama cuando se acabaron los frames de la animaci�n.
        ...
        /// <summary>
        ///     Evento que se llama cada vez que la animaci�n actual finaliza.
        ///     Se llama cuando se acabaron los frames de la animaci�n.
        ///     Si se anima en Loop, se llama cada vez que termina.
        /// </summary>
