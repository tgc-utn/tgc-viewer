...
namespace TGC.Core.SkeletalAnimation
{
    ...
    ///     su ubicicaci�n en el espacio en base a las transformaciones del hueso durante la animaci�n.
    ///     El modelo no debe ser transformado por afuera una vez que es adjuntado a un hueso.
    ///     El renderizado del modelo debe hacerse por afuera de la animaci�n esquel�tica.
    /// </summary>
    public class TgcSkeletalBoneAttach
    {
        ...
        /// <summary>
        ///     Actualiza los valores del Attachment en base a los par�metros configurados.
