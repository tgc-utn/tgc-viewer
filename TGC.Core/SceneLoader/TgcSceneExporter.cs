...
namespace TGC.Core.SceneLoader
{
    ...
    public class TgcSceneExporter
    {
        ...
        public MeshExport appendMeshes(string meshName, MeshExport mExp1, MeshExport mExp2)
        {
            ...
            {
                throw new Exception("Se intent� juntar dos Mallas de formato distintos: " + mExp1.MeshData.name + " y " +
                                    mExp2.MeshData.name);
            }
        ...
        public TgcMesh mergeTwoMeshes(TgcMesh mesh1, TgcMesh mesh2)
        {
            ...
            {
                throw new Exception("Se intent� juntar dos Mallas de formato distintos: " + mesh1.Name + " y " +
                                    mesh2.Name);
            }
