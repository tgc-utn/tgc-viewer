...
{
    /// <summary>
    ///     Representa una malla est�tica.
    ///     Puede moverse y rotarse pero no tiene animaci�n.
    ///     La malla puede tener colores por v�rtice, texturas y lightmaps.
    ///     Puede crearse como una malla nueva o como una instancia de otra existente y reutilizar as� su geometr�a.
    /// </summary>
    public class TgcMesh : IRenderObject, ITransformObject
    {
        ...
        ///     Si la malla es el original y tiene varias instancias adjuntadas, se hace dispose() tambi�n de las instancias.
        /// </summary>
        public void Dispose()
        {
            enabled = false;
        ...
        /// <summary>
        ///     Devuelve un array con todas las posiciones de los v�rtices de la malla
        /// </summary>
        ...
        ///     Esta nueva textura no va a ser utilizada por ning�n tri�ngulo si no se
