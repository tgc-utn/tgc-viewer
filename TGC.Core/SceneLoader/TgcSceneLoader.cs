...
namespace TGC.Core.SceneLoader
{
    ...
    public class TgcSceneLoader
    {
        ...
        /// </summary>
        /// <param name="sceneFileName">Nombre del archivo XML que tiene la informaci�n de la escena</param>
        ...
        public TgcScene loadScene(TgcSceneData sceneData, string mediaPath)
        {
            ...
            //Cargar parte de PortalRendering, solo hay informaci�n
        ...
        /// <summary>
        ///     Convierte un TGCQuaternion a rotaci�n de Euler
        /// </summary>
