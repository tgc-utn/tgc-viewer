...
namespace TGC.Core.Geometry
{
    ...
    public class TgcArrow
    {
        ...
        /// <summary>
        ///     Tama�o de la cabeza de la flecha. Debe ser mayor a cero.
        /// </summary>
        ...
        /// <summary>
        ///     Actualizar par�metros de la flecha en base a los valores configurados
        /// </summary>
        ...
        /// <param name="headSize">Tama�o de la punta de la flecha</param>
        /// <returns>Flecha creada</returns>
