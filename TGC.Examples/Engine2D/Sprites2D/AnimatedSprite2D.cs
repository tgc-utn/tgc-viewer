...
namespace TGC.Examples.Engine2D.Sprites2D
{
    /// <summary>
    ///     Ejemplo AnimatedSprite2D:
    ...
    /// </summary>
    public class AnimatedSprite2D : TGCExampleViewer
    {
        ...
        public AnimatedSprite2D(string mediaDir, string shadersDir, TgcUserVars userVars, TgcModifiers modifiers)
            : base(mediaDir, shadersDir, userVars, modifiers)
        {
            Category = "2D";
            Name = "Sprite 2D Animado";
