...
namespace TGC.Examples.Engine2D
{
	...
	///     Muestra como dibujar un Sprite. Un Sprite es una imágen que se dibuja en dos dimensiones, arriba de todo la escena 3D.
	/// 	Muestra tambien como dibujar un Sprite Animado en 2D. Es similar al concepto de un GIF animado. Se tiene una textura de Sprite, compuesta por un conjunto de tiles, o frames de animación.
	...
	public class Sprite2D : TGCExampleViewer
	{
		...
		public override void Init()
		{
			...
			sprite.Position = new Vector2(FastMath.Max(D3DDevice.Instance.Width / 2 - textureSize.Width / 2, 0), FastMath.Max(D3DDevice.Instance.Height / 2 - textureSize.Height / 2, 0));
			...
			animatedSprite.Position = new Vector2(D3DDevice.Instance.Width / 2 - textureSizeAnimado.Width / 2, D3DDevice.Instance.Height / 2 - textureSizeAnimado.Height / 2);

			//Modifiers para variar parametros del sprite
			Modifiers.addVertex2f("position", new Vector2(0, 0), new Vector2(D3DDevice.Instance.Width, D3DDevice.Instance.Height), sprite.Position);
			...
			Modifiers.addVertex2f("positionAnimated", new Vector2(0, 0), new Vector2(D3DDevice.Instance.Width, D3DDevice.Instance.Height), animatedSprite.Position);
			Modifiers.addVertex2f("scalingAnimated", new Vector2(0, 0), new Vector2(4, 4), animatedSprite.Scaling);
			...
			box.Transform = Matrix.RotationX(FastMath.QUARTER_PI);
		...
		public override void Update()
		{
			...
			animatedSprite.Position = (Vector2)Modifiers["positionAnimated"];
			animatedSprite.Scaling = (Vector2)Modifiers["scalingAnimated"];
