...
namespace TGC.Examples.Otros
{
    ...
    public class EjemploBatchPrimitivesDx : TgcExample
    {
        ...
        public EjemploBatchPrimitivesDx(string mediaDir, string shadersDir, TgcUserVars userVars, TgcModifiers modifiers, TgcAxisLines axisLines, TgcCamera camara) : base(mediaDir, shadersDir, userVars, modifiers, axisLines, camara)
        {
            this.Category = "Otros";
            this.Name = "BatchPrimitivesDx";
            this.Description = "BatchPrimitivesDx";
        }
