...
namespace TGC.Examples.UserControls.Networking
{
    public class TgcSocketServer
    {
        ...
        /// </summary>
        internal int NewClientsCount => newConnectedClients.Count;
        ...
        ///     están pendientes de lectura.
        /// </summary>
        internal int DisconnectedClientsCount => disconnectedClients.Count;
        ...
        public void sendToClient(int playerId, TgcSocketSendMsg msg)
        {
            ...
            if (clientInfo != null) sendToClient(clientInfo, msg);
        }
        ...
        {
            foreach (var clientInfo in allClients) sendToClient(clientInfo, msg);
        }
