...
namespace TGC.Examples.UserControls
{
    /// <summary>
    ...
    public class TgcUserVars
    {
        ...
        public void setValue(string name, object value, Color foreColor)
        {
            ...
            if (row == null) throw new Exception("Se intentó cargar una UserVar inexistente: " + name);
        ...
        {
            var row = findRowByVarName(name);
            if (row == null) throw new Exception("Se intentó acceder una UserVar inexistente: " + name);
