...
namespace TGC.Examples.GeometryBasics
{
    ...
    public class EjemploEsfera : TGCExampleViewer
    {
        ...
        public EjemploEsfera(string mediaDir, string shadersDir, TgcUserVars userVars, TgcModifiers modifiers)
        ...
        public override void Init()
        {
            ...
            Modifiers.addVertex3f("position", new TGCVector3(-100, -100, -100), new TGCVector3(100, 100, 100), TGCVector3.Empty);
            Modifiers.addVertex3f("rotation", new TGCVector3(-180, -180, -180), new TGCVector3(180, 180, 180), TGCVector3.Empty);
